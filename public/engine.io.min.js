...
! function(t, e) {
    ...
    return function(t) {
        ...
        var u = r(0),
            c = function(t) {
                function e(t) {
                    ...
                    }(this, e), (r = i(this, s(e).call(this))).opts = t, r.query = t.query, r.readyState = "", r.socket = t.socket, r
                }
                var r, n, c;
                return function(t, e) {
        ...
        e.polling = function(t) {
            ...
            if ("undefined" != typeof location) {
                var a = "https:" === location.protocol,
                    u = location.port;
                u || (u = a ? 443 : 80), e = t.hostname !== location.hostname || u !== t.port, r = t.secure !== a
            }
        ...
        var c = r(3),
            ...
            h = function(t) {
                function e() {
                    return o(this, e), s(this, a(e).apply(this, arguments))
                }
                var r, n, c;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    value: function(t) {
                        var e = this;
                        f.decodePayload(t, this.socket.binaryType).forEach((function(t, r, n) {
                    ...
                    value: function(t) {
                        var e = this;
                        this.writable = !1, f.encodePayload(t, (function(t) {
                    ...
                    value: function() {
                        var t = this.query || {},
                            ...
                            r = "";
                        return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = l()), this.supportsBinary || t.sid || (t.b64 = 1), t = p.encode(t), this.opts.port && ("https" === e && 443 !== Number(this.opts.port) || "http" === e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port), t.length && (t = "?" + t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + t
                    }
                }, {
                    key: "name",
                    get: function() {
        ...
        t.exports = function(t, e) {
            return new n(t, e)
        }, t.exports.Socket = n, t.exports.protocol = n.protocol, t.exports.Transport = r(3), t.exports.transports = r(6), t.exports.parser = r(0)
    }, function(t, e, r) {
        function n() {
            ...
            d = function(t) {
                function e(t) {
                    ...
                    return i(this, e), r = a(this, u(e).call(this)), t && "object" === o(t) && (s = t, t = null), t ? (t = h(t), s.hostname = t.host, s.secure = "https" === t.protocol || "wss" === t.protocol, s.port = t.port, t.query && (s.query = t.query)) : s.host && (s.hostname = h(s.host).host), r.secure = null != s.secure ? s.secure : "undefined" != typeof location && "https:" === location.protocol, s.hostname && !s.port && (s.port = r.secure ? "443" : "80"), r.hostname = s.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), r.port = s.port || ("undefined" != typeof location && location.port ? location.port : r.secure ? 443 : 80), r.transports = s.transports || ["polling", "websocket"], r.readyState = "", r.writeBuffer = [], r.prevBufferLen = 0, r.opts = n({
                        ...
                        transportOptions: {}
                    }, s), r.opts.path = r.opts.path.replace(/\/$/, "") + "/", "string" == typeof r.opts.query && (r.opts.query = y.decode(r.opts.query)), r.id = null, r.upgrades = null, r.pingInterval = null, r.pingTimeout = null, r.pingTimeoutTimer = null, r.open(), r
                }
                var r, f, d;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    value: function(t) {
                            ...
                            n || (r.send([{
                                ...
                                if (!n)
                                    if ("pong" === t.type && "probe" === t.data) {
                                        ...
                                        e.priorWebsocketSuccess = "websocket" === r.name, o.transport.pause((function() {
                                            n || "closed" !== o.readyState && (f(), o.setTransport(r), r.send([{
                                                type: "upgrade"
                                            }]), o.emit("upgrade", r), r = null, o.upgrading = !1, o.flush())
                                        }))
                                    } else {
                                        var i = new Error("probe error");
                                        i.transport = r.name, o.emit("upgradeError", i)
                                    }
                            })))
                        }
                        ...
                        function a(t) {
                            ...
                            e.transport = r.name, s(), o.emit("upgradeError", e)
                        }
                        ...
                        function f() {
                            r.removeListener("open", i), r.removeListener("error", a), r.removeListener("close", u), o.removeListener("close", c), o.removeListener("upgrading", p)
                        }
                        e.priorWebsocketSuccess = !1, r.once("open", i), r.once("error", a), r.once("close", u), this.once("close", c), this.once("upgrading", p), r.open()
                    }
                }, {
                    key: "onOpen",
                    value: function() {
                        if (this.readyState = "open", e.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause)
                    ...
                    key: "onError",
                    value: function(t) {
                        e.priorWebsocketSuccess = !1, this.emit("error", t), this.onClose("transport error", t)
                    }
                }, {
                    key: "onClose",
                    value: function(t, e) {
                ...
                }]) && s(r.prototype, f), d && s(r, d), e
            }(f);
        d.priorWebsocketSuccess = !1, d.protocol = l.protocol, t.exports = d
    }, function(t, e) {
        try {
        ...
        var v = null != new(r(2))({
            ...
            g = function(t) {
                function e(t) {
                    var r;
                    if (i(this, e), r = u(this, c(e).call(this, t)), "undefined" != typeof location) {
                        var n = "https:" === location.protocol,
                            o = location.port;
                        o || (o = n ? 443 : 80), r.xd = "undefined" != typeof location && t.hostname !== location.hostname || o !== t.port, r.xs = t.secure !== n
                    }
                    var s = t && t.forceBase64;
                    return r.supportsBinary = v && !s, r
                }
                return p(e, t), a(e, [{
                    key: "request",
                    value: function() {
            ...
            w = function(t) {
                function e(t, r) {
                    var n;
                    return i(this, e), (n = u(this, c(e).call(this))).opts = r, n.method = r.method || "GET", n.uri = t, n.async = !1 !== r.async, n.data = void 0 !== r.data ? r.data : null, n.isBinary = r.isBinary, n.supportsBinary = r.supportsBinary, n.create(), n
                }
                return p(e, t), a(e, [{
                    key: "create",
                    value: function() {
                        var t = d(this.opts, "agent", "enablesXDR", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized");
                        t.xdomain = !!this.opts.xd, t.xscheme = !!this.opts.xs;
                        var r = this.xhr = new l(t),
                            n = this;
                        try {
                            ...
                            "withCredentials" in r && (r.withCredentials = this.opts.withCredentials), this.opts.requestTimeout && (r.timeout = this.opts.requestTimeout), this.hasXDR() ? (r.onload = function() {
                                ...
                                if (2 === r.readyState) try {
                                    ...
                                    (n.supportsBinary && "application/octet-stream" === t || "application/octet-stream; charset=UTF-8" === t) && (r.responseType = "arraybuffer")
                                } catch (t) {}
                                4 === r.readyState && (200 === r.status || 1223 === r.status ? n.onLoad() : setTimeout((function() {
                                    n.onError("number" == typeof r.status ? r.status : 0)
                                }), 0))
                            }, r.send(this.data)
                        } catch (t) {
                            return void setTimeout((function() {
                    ...
                    value: function(t) {
                        if (void 0 !== this.xhr && null !== this.xhr) {
                            if (this.hasXDR() ? this.xhr.onload = this.xhr.onerror = b : this.xhr.onreadystatechange = b, t) try {
                                this.xhr.abort()
                            } catch (t) {}
        ...
        if (w.requestsCount = 0, w.requests = {}, "undefined" != typeof document)
            ...
            addEventListener("onpagehide" in m ? "pagehide" : "unload", k, !1)
        }

        function k() {
            for (var t in w.requests) w.requests.hasOwnProperty(t) && w.requests[t].abort()
        }
        t.exports = g, t.exports.Request = w
    }, function(t, e, r) {
        ...
        t.exports = function(t, e, r) {
            var a, u = t.type,
                c = t.data;
            return o && c instanceof Blob ? e ? r(c) : s(c, r) : i && (c instanceof ArrayBuffer || (a = c, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(a) : a && a.buffer instanceof ArrayBuffer)) ? e ? r(c instanceof ArrayBuffer ? c : c.buffer) : s(new Blob([c]), r) : r(n[u] + (c || ""))
        }
    }, function(t, e, r) {
        var n, o = r(8),
        ...
        ! function(t) {
            ...
            e.encode = function(e) {
                ...
                var p = new ArrayBuffer(a),
                    f = new Uint8Array(p);
                for (r = 0; r < u; r += 4) n = t.indexOf(e[r]), o = t.indexOf(e[r + 1]), i = t.indexOf(e[r + 2]), s = t.indexOf(e[r + 3]), f[c++] = n << 2 | o >> 4, f[c++] = (15 & o) << 4 | i >> 2, f[c++] = (3 & i) << 6 | 63 & s;
                return p
            }
        ...
        var d = function(t) {
            function e(t) {
                ...
                }(this, a(e).call(this, t))).query = r.query || {}, c || (c = f.___eio = f.___eio || []), r.index = c.length;
                var o = i(r);
                return c.push((function(t) {
                    o.onData(t)
                })), r.query.j = r.index, "function" == typeof addEventListener && addEventListener("beforeunload", (function() {
                    o.script && (o.script.onerror = y)
                }), !1), r
            }
            var r, p, d;
            return function(t, e) {
                ...
                key: "doClose",
                value: function() {
                    this.script && (this.script.parentNode.removeChild(this.script), this.script = null), this.form && (this.form.parentNode.removeChild(this.form), this.form = null, this.iframe = null), s(a(e.prototype), "doClose", this).call(this)
                }
            }, {
                key: "doPoll",
                value: function() {
                ...
                value: function(t, e) {
                    ...
                    this.form.action = this.uri(), u(), t = t.replace(h, "\\\n"), this.area.value = t.replace(l, "\\n");
                    try {
                        this.form.submit()
                    } catch (t) {}
        ...
        var u = r(3),
            ...
            h = r(20),
            y = h.WebSocket,
            d = h.usingBrowserWebSocket,
            m = h.defaultBinaryType,
            b = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase(),
            v = function(t) {
                function e(t) {
                    var r;
                    return function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), r = i(this, s(e).call(this, t)), t && t.forceBase64 && (r.supportsBinary = !1), r.supportsBinary = !0, r
                }
                var r, n, h;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    value: function() {
                        if (this.check()) {
                            ...
                            t = b ? l(this.opts, "localAddress") : l(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress"), this.opts.extraHeaders && (t.headers = this.opts.extraHeaders);
                            try {
                                this.ws = d && !b ? r ? new y(e, r) : new y(e) : new y(e, r, t)
                            } catch (t) {
                    ...
                    value: function(t) {
                        var e = this;
                        this.writable = !1;
                        for (var r = t.length, n = 0, o = r; n < o; n++) ! function(t) {
                            c.encodePacket(t, e.supportsBinary, (function(n) {
                                var o = {};
                                d || (t.options && (o.compress = t.options.compress), e.opts.perMessageDeflate && ("string" == typeof n ? Buffer.byteLength(n) : n.length) < e.opts.perMessageDeflate.threshold && (o.compress = !1));
                                try {
                                    d ? e.ws.send(n) : e.ws.send(n, o)
                                } catch (t) {}--r || (e.emit("flush"), setTimeout((function() {
                                    e.writable = !0, e.emit("drain")
                                }), 0))
                            }))
                        }(t[n])
                    ...
                    value: function() {
                        var t = this.query || {},
                            ...
                            r = "";
                        return this.opts.port && ("wss" === e && 443 !== Number(this.opts.port) || "ws" === e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port), this.opts.timestampRequests && (t[this.opts.timestampParam] = f()), this.supportsBinary || (t.b64 = 1), (t = p.encode(t)).length && (t = "?" + t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + t
                    }
                }, {
                    key: "check",
                    value: function() {
                        return !(!y || "__initialize" in y && this.name === e.prototype.name)
                    }
                }, {
                    key: "name",
                    get: function() {
